...
if(isset($_POST["add_to_cart"]))
{
    if(isset($_SESSION["shopping_cart"]))
    {
        ...
        {
            header("Location: http://localhost/diploma/asd/index2.php");
        }
    }
    else
    {
...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css">aa
  <!-- Google Fonts Roboto -->
    ...
    <div class="container">
      ...
      <section class="text-center mb-4">
        <div class="row wow fadeIn">
            ...
            $query = "SELECT * FROM `tbl_product` WHERE `type` = 'rare'";
